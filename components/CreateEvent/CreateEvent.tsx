		...
		<div>
			...
			<Formik
				...
				validate={(values) => {
					...
					if (!values.startTime)
						errors.startTime = 'Vyplňte prosím datum začátku akce';
					...
					if (!values.contactPhone)
						errors.contactPhone = 'Vyplňte prosím telefonní číslo kontaktu';
					if (!values.contactEmail)
						errors.contactEmail = 'Vyplňte prosím email kontaktu';
					return errors;
				}}
				onSubmit={(values) => {
					submit(values);
								...
								<div className="text-center sm:text-left whitespace-nowrap">
									<Link href="/" passHref>
										<button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
											...
											<span className="inline-block ml-1">Zpět na mapu</span>
										</button>
									</Link>
								</div>
							</div>
